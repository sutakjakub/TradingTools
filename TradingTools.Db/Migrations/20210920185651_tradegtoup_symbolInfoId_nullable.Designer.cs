...
namespace TradingTools.Db.Migrations
{
    ...
    [Migration("20210920185651_tradegtoup_symbolInfoId_nullable")]
    partial class tradegtoup_symbolInfoId_nullable
    {
            ...
            modelBuilder.Entity("TradingTools.Db.Entities.T2TradeEntity", b =>
                {
                    ...
                    b.Property<long?>("T2TradeGroupEntityId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("T2TradeGroupEntityId");
            ...
            modelBuilder.Entity("TradingTools.Db.Entities.T2TradeEntity", b =>
                {
                    ...
                    b.HasOne("TradingTools.Db.Entities.T2TradeGroupEntity", null)
                        .WithMany("Trades")
                        .HasForeignKey("T2TradeGroupEntityId");
